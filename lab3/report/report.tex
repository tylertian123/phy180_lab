...
The period of a linear pendulum, with small amplitudes and negligible damping, is
\begin{equation}
    T \approx 2\pi\sqrt{\frac{L}{g}} = 2\frac{\pi}{\sqrt{g}}\sqrt{L} \approx 2.006L^{0.5}
    \label{eqn:theoretical_period}
\end{equation}

By comparing Equation \ref{eqn:theoretical_period} with \ref{eqn:period}, the theoretical value for \(k\) is found to be
